...
router.get("/",requireAuth, requireRole("developer","usuariobascula", "liderlogistica","auxiliarlogistica1", "auxiliarlogistica2", "torrecontrollogistica"), getClientes);
router.get("/:id",requireAuth, requireRole("developer","usuariobascula","liderlogistica","auxiliarlogistica1", "auxiliarlogistica2", "torrecontrollogistica"), getClienteById);
